...
exports.HOLIDAY_WORDS = exports.HOLIDAY_PHRASES = exports.GROUP_HOLIDAYS = exports.HOLIDAYS = exports.HOLIDAY_DEFS = void 0;
...
exports.setHolidayGroups = setHolidayGroups;
exports.setHolidayOverrides = setHolidayOverrides;
exports.getHolidayGroups = getHolidayGroups;
exports.getHolidayOverrides = getHolidayOverrides;
...
function setHolidayGroups(groups) {
    holidayGroups = groups;
}
function setHolidayOverrides(overrides) {
    holidayOverrides = overrides;
}
function getHolidayGroups() {
    return holidayGroups;
}
function getHolidayOverrides() {
...
function holidayEnabled(name) {
    ...
    if (canonical in holidayOverrides)
        return holidayOverrides[canonical];
    const group = entry.group;
    if (group && group in holidayGroups)
        return holidayGroups[group];
    return true;
}
function isHolidayQualifier(lower) {
    ...
    if (!match)
        return false;
    return match[2] in exports.HOLIDAYS;
}
